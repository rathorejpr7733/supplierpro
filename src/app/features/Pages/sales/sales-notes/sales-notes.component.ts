...
export interface SalesNotesElement  {
      id:string;
      customer:string;
      reference: number;
      creation:string
...
}const ELEMENT_DATA: SalesNotesElement[] = [
  {
    id: 'SO-001',
...
@Component({
  ...
  styleUrl: './sales-notes.component.scss'
})
export class SalesNotesComponent {
  displayedColumns: string[] = [
   ...
   selection = new SelectionModel<SalesNotesElement>(true, []);
...
checkboxLabel(row?: SalesNotesElement): string {
  if (!row) {
