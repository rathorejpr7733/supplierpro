...
export interface ProformaElement  {
      id:string;
      customer:string;
      reference: number;
      creation:string
      ...
      shipping:string
      action:string;
}const ELEMENT_DATA: ProformaElement[] = [
  {
    id: 'SO-001',
...
export class ProformaComponent {
   ...
   selection = new SelectionModel<ProformaElement>(true, []);
...
checkboxLabel(row?: ProformaElement): string {
  if (!row) {
